...
!(function (e, t) {
  ...
  const c = {
    ...
    on: function () {
      ...
      "function" == typeof t[1] && (([i, r, a] = t), (n = void 0)),
        a || (a = !1);
      const c = i.split(" ");
      let p;
          ...
          if (
            ...
            for (let e = i.length - 1; e >= 0; e -= 1) {
              ...
              (r &&
                ...
                ? (s.removeEventListener(t, n.proxyListener, a), i.splice(e, 1))
                : r ||
  ...
  var $ = {
    loopCreate: function () {
      ...
      for (let e = 0; e < l.length; e += 1)
        r.append(d(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = o.length - 1; e >= 0; e -= 1)
        r.prepend(d(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  var j = {
    attachEvents: function () {
      ...
      (e.onTouchStart = O.bind(e)),
        ...
        (e.onClick = G.bind(e)),
        n.touch && !N && (t.addEventListener("touchstart", _), (N = !0)),
        B(e, "on");
    },
  ...
  const U = [
    function (e) {
      ...
      s({
        ...
        Object.assign(t.navigation, { update: l, init: u, destroy: h });
    },
    function (e) {
